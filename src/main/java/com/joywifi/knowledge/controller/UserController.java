...
public class UserController {
    ...
    @CurrentUserQuery(type = CurrentUserQuery.QueryEnum.EDIT, clazz = User.class)
    ...
    public String updateRole(@PathVariable("id") String id, String[] roleIds, RedirectAttributes redirectAttributes) {
        User user = userService.get(id);
    ...
    public String editPermission(@PathVariable("id") String id, Model model) {
        User user = userService.get(id);
        model.addAttribute("user", user);
    ...
    public String updatePermission(@PathVariable("id") String id, String permission, RedirectAttributes redirectAttributes) {
        User user = userService.get(id);
