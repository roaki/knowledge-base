...
<div class="am-g">
  <div class="am-u-sm-12 am-u-md-10">
    <form class="am-form" action="${ctx}/blog/update" method="post">
      ...
      <div class="am-form-group">
        ...
        <textarea class="" name="summary" rows="4" id="blog-summary" value="${blog.summary}"></textarea>
      </div>
      <div class="am-form-group">
        <label for="blog-categoryTitle">分类</label>
        <select id="blog-categoryTitle" name="categoryTitle" value="${blog.category}">
      ...
      <div class="am-form-group">
        ...
        <script id="blog-content" name="content" value="${blog.content}" type="text/plain"></script>
      </div>
