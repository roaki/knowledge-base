...
<div class="am-g">
  <div class="am-u-sm-12 am-u-md-8">
    <form class="am-form am-form-horizontal" action="${ctx}/authority/update/${authority.id}" method="post">
      <div class="am-form-group">
        <label for="authority-name" class="am-u-sm-3 am-form-label">权限名称</label>

        <div class="am-u-sm-9">
          <input type="text" id="authority-name" name="name" value="${authority.name}" required />
        </div>
      </div>
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
          <input type="text" id="authority-permission" name="permission" value="${authority.permission}" required />
        </div>
      </div>
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
          <select name="parentId" data-am-selected="{searchBox: 1, maxHeight: 200}">
            <option value="${authority.parentId}">无</option>
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
          <textarea class="" rows="5" id="authority-summary" name="summary" value="${authority.summary}" placeholder="摘要"></textarea>
        </div>
      </div>
