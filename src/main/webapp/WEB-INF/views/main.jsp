  ...
  <div class="am-collapse am-topbar-collapse" id="doc-topbar-collapse">
    ...
    <div class="am-topbar-right">
      <div class="am-dropdown" data-am-dropdown="{boundary: '.am-topbar'}">
        <button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle>其他
    ...
    <c:forEach items="${blogs.content}" var="blog">
      <article class="blog-main">
        ...
        <h4 class="am-article-meta blog-meta"><a
                href="${ctx}/?criteria_EQ_creator.username=${blog.creator.username}">${blog.creator.username}</a> 发表于
      ...
      <section class="am-panel am-panel-default">
        ...
        <div class="am-panel-bd">
          <p><c:forEach items="${tags}" var="tag"><a
                  href="${ctx}/?criteria_EQ_tags.title=${tag.title}">${tag.title}</a>&nbsp;&nbsp;</c:forEach></p>
          <a class="am-btn am-btn-success am-btn-sm" href="#">更多</a>
        </div>
      </section>
      <section class="am-panel am-panel-default">
